angular.module('firstClass').controller('EditScoutSheetController', ['$scope', '$mdBottomSheet', 'editingScout', '$mdDialog', '$state',
  function ($scope, $mdBottomSheet, editingScout, $mdDialog, $state) {
