LoginController.$inject = ['$scope', '$rootScope', 'persistenceService', 'authService', '$state', '$log', '$mdToast'];
export default function LoginController($scope, $rootScope, persistenceService, authService, $state, $log, $mdToast) {
