ScoutController.$inject = ['scoutService', '$mdBottomSheet', 'requirementService',
  ...
  'requirements'];
export default function ScoutController(scoutService, $mdBottomSheet, requirementService, $mdDialog, $filter, $mdToast, scoutDialogService,
