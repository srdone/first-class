export default LoginDirectiveController;

LoginDirectiveController.$inject = ['$scope', '$rootScope', 'persistenceService', 'authService', '$state', '$log', '$mdToast'];
function LoginDirectiveController($scope, $rootScope, persistenceService, authService, $state, $log, $mdToast) {
